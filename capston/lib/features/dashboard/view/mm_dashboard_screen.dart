...
class MmDashboardScreen extends StatefulWidget {
  final DashboardVM vm;
  const MmDashboardScreen({super.key, required this.vm});

  @override
  State<MmDashboardScreen> createState() => _MmDashboardScreenState();
}

class _MmDashboardScreenState extends State<MmDashboardScreen>
  ...
  static const _mapByTab = <int, String>{
    0: 'assets/images/mul.png',
    1: 'assets/images/mul_hu.png',
    2: 'assets/images/mul_tem.png',
  };
    ...
    child: ConstrainedBox(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 10),
          Text('🌡️ 온도와 습도가 모두 적정 범위예요.',
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 14, height: 1.45, color: Colors.black87)),
          Text('🍃 현재 공기질은 안정적입니다.',
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 14, height: 1.45, color: Colors.black87)),
          Text('🫁 쾌적한 환경이 유지되고 있습니다.',
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 14, height: 1.45, color: Colors.black87)),
          Text('💨 정기적인 환기만 해주시면 됩니다.',
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 14, height: 1.45, color: Colors.black87)),
          SizedBox(height: 2),
        ],
...
class _MetricPlaceholder extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    TextStyle v(double f) => TextStyle(fontSize: f, fontWeight: FontWeight.w800, color: Colors.grey[500]);
    return Padding(
